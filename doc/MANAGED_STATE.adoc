...
digraph g {
  ...
  "RenderEntities0" -> "RenderEntitiesInstanced0";
  "RenderEntitiesInstanced0" -> "RenderBlockEntities0";
  ...
  "RenderEntities1" -> "RenderEntitiesInstanced1";
  "RenderEntitiesInstanced1" -> "RenderBlockEntities1";
