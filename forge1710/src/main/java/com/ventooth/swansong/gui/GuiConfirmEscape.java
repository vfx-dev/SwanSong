...
public class GuiConfirmEscape extends GuiScreen {
    private final Supplier<? extends GuiScreen> parentScreen;
    private final ConfigEntry.RootScreen rootScreen;
    private final String text;

    public GuiConfirmEscape(Supplier<? extends GuiScreen> parentScreen, ConfigEntry.RootScreen rootScreen) {
        this.parentScreen = parentScreen;
        this.rootScreen = rootScreen;
        text = I18n.format("gui.swansong.shaders.exit.query");
    }
